...
# instance fields
.field private mContextPref:Landroid/preference/nubia/CheckBoxPreference;

.field private mDefaultAssitPref:Lcom/android/settings_ex/applications/DefaultAssistPreference;

.field private mHandler:Landroid/os/Handler;

.field private mScreenshotPref:Landroid/preference/nubia/CheckBoxPreference;
...
.method private confirmNewAssist(Ljava/lang/String;)V
    ...
    invoke-direct {v1, v7}, Lcn/nubia/commonui/app/AlertDialog$Builder;-><init>(Landroid/content/Context;)V

    .line 166
    .local v1, "builder":Lcn/nubia/commonui/app/AlertDialog$Builder;
    invoke-virtual {v1, v6}, Lcn/nubia/commonui/app/AlertDialog$Builder;->setTitle(Ljava/lang/CharSequence;)Lcn/nubia/commonui/app/AlertDialog$Builder;

    move-result-object v7

    invoke-virtual {v7, v3}, Lcn/nubia/commonui/app/AlertDialog$Builder;->setMessage(Ljava/lang/CharSequence;)Lcn/nubia/commonui/app/AlertDialog$Builder;

    move-result-object v7

    invoke-virtual {v7, v9}, Lcn/nubia/commonui/app/AlertDialog$Builder;->setCancelable(Z)Lcn/nubia/commonui/app/AlertDialog$Builder;

    move-result-object v7

    const v8, 0x7f0c0abe

    invoke-virtual {v7, v8, v4}, Lcn/nubia/commonui/app/AlertDialog$Builder;->setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Lcn/nubia/commonui/app/AlertDialog$Builder;
    ...
    invoke-virtual {v7, v8, v9}, Lcn/nubia/commonui/app/AlertDialog$Builder;->setNegativeButton(ILandroid/content/DialogInterface$OnClickListener;)Lcn/nubia/commonui/app/AlertDialog$Builder;
...
.method private updateUi()V
    ...
    iget-object v4, p0, Lcom/android/settings_ex/applications/ManageAssist;->mContextPref:Landroid/preference/nubia/CheckBoxPreference;
    ...
    iget-object v4, p0, Lcom/android/settings_ex/applications/ManageAssist;->mScreenshotPref:Landroid/preference/nubia/CheckBoxPreference;
    ...
    .line 138
    :goto_2
    iget-object v3, p0, Lcom/android/settings_ex/applications/ManageAssist;->mScreenshotPref:Landroid/preference/nubia/CheckBoxPreference;
    ...
    .line 139
    iget-object v3, p0, Lcom/android/settings_ex/applications/ManageAssist;->mContextPref:Landroid/preference/nubia/CheckBoxPreference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/applications/ManageAssist;->mContextPref:Landroid/preference/nubia/CheckBoxPreference;
    ...
    :goto_0
    invoke-virtual {v3, v0}, Landroid/preference/nubia/CheckBoxPreference;->setChecked(Z)V

    .line 62
    iget-object v0, p0, Lcom/android/settings_ex/applications/ManageAssist;->mContextPref:Landroid/preference/nubia/CheckBoxPreference;
    ...
    iput-object v0, p0, Lcom/android/settings_ex/applications/ManageAssist;->mScreenshotPref:Landroid/preference/nubia/CheckBoxPreference;

    .line 65
    iget-object v0, p0, Lcom/android/settings_ex/applications/ManageAssist;->mScreenshotPref:Landroid/preference/nubia/CheckBoxPreference;
