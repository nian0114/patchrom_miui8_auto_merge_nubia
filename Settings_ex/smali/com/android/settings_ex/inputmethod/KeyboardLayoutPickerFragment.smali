...
.method private createPreferenceHierarchy()Landroid/preference/PreferenceScreen;
    ...
    new-instance v5, Landroid/preference/nubia/CheckBoxPreference;

    invoke-direct {v5, v1}, Landroid/preference/nubia/CheckBoxPreference;-><init>(Landroid/content/Context;)V

    .line 143
    .local v5, "pref":Landroid/preference/nubia/CheckBoxPreference;
    invoke-virtual {v3}, Landroid/hardware/input/KeyboardLayout;->getLabel()Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v5, v7}, Landroid/preference/nubia/CheckBoxPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v5, v7}, Landroid/preference/nubia/CheckBoxPreference;->setSummary(Ljava/lang/CharSequence;)V
    ...
    .end local v5    # "pref":Landroid/preference/nubia/CheckBoxPreference;
    :cond_0
    return-object v6
.end method
...
.method private updateCheckedState()V
    ...
    .line 157
    .local v1, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Landroid/preference/nubia/CheckBoxPreference;Landroid/hardware/input/KeyboardLayout;>;"
    ...
    .line 160
    .end local v1    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Landroid/preference/nubia/CheckBoxPreference;Landroid/hardware/input/KeyboardLayout;>;"
    :cond_1
    return-void
.end method
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .prologue
    .line 101
    instance-of v3, p2, Landroid/preference/nubia/CheckBoxPreference;
    ...
    .line 103
    .local v0, "checkboxPref":Landroid/preference/nubia/CheckBoxPreference;
    iget-object v3, p0, Lcom/android/settings_ex/inputmethod/KeyboardLayoutPickerFragment;->mPreferenceMap:Ljava/util/HashMap;
    ...
    .line 116
    .end local v0    # "checkboxPref":Landroid/preference/nubia/CheckBoxPreference;
    ...
    .line 110
    .restart local v0    # "checkboxPref":Landroid/preference/nubia/CheckBoxPreference;
