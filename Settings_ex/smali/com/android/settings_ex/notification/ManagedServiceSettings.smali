...
.method private updateList(Ljava/util/List;)V
    ...
    new-instance v2, Landroid/preference/nubia/CheckBoxPreference;

    iget-object v6, p0, Lcom/android/settings_ex/notification/ManagedServiceSettings;->mContext:Landroid/content/Context;

    invoke-direct {v2, v6}, Landroid/preference/nubia/CheckBoxPreference;-><init>(Landroid/content/Context;)V

    .line 106
    .local v2, "pref":Landroid/preference/nubia/CheckBoxPreference;
    const/4 v6, 0x0

    invoke-virtual {v2, v6}, Landroid/preference/nubia/CheckBoxPreference;->setPersistent(Z)V
    ...
    invoke-virtual {v2, v6}, Landroid/preference/nubia/CheckBoxPreference;->setIcon(Landroid/graphics/drawable/Drawable;)V

    .line 108
    invoke-virtual {v2, v5}, Landroid/preference/nubia/CheckBoxPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v2, v6}, Landroid/preference/nubia/CheckBoxPreference;->setChecked(Z)V
    ...
    invoke-virtual {v2, v6}, Landroid/preference/nubia/CheckBoxPreference;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V
    ...
    .end local v2    # "pref":Landroid/preference/nubia/CheckBoxPreference;
