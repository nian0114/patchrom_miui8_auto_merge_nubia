...
.method private updateAgents()V
    ...
    new-instance v6, Landroid/preference/nubia/CheckBoxPreference;

    invoke-direct {v6, v2}, Landroid/preference/nubia/CheckBoxPreference;-><init>(Landroid/content/Context;)V

    .line 106
    .local v6, "preference":Landroid/preference/nubia/CheckBoxPreference;
    iput-object v6, v0, Lcom/android/settings_ex/TrustAgentSettings$AgentInfo;->preference:Landroid/preference/nubia/CheckBoxPreference;

    .line 107
    invoke-virtual {v6, v7}, Landroid/preference/nubia/CheckBoxPreference;->setPersistent(Z)V

    .line 108
    iget-object v8, v0, Lcom/android/settings_ex/TrustAgentSettings$AgentInfo;->label:Ljava/lang/CharSequence;

    invoke-virtual {v6, v8}, Landroid/preference/nubia/CheckBoxPreference;->setTitle(Ljava/lang/CharSequence;)V

    .line 109
    iget-object v8, v0, Lcom/android/settings_ex/TrustAgentSettings$AgentInfo;->icon:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v6, v8}, Landroid/preference/nubia/CheckBoxPreference;->setIcon(Landroid/graphics/drawable/Drawable;)V

    .line 110
    invoke-virtual {v6, v7}, Landroid/preference/nubia/CheckBoxPreference;->setPersistent(Z)V

    .line 111
    invoke-virtual {v6, p0}, Landroid/preference/nubia/CheckBoxPreference;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V
    ...
    invoke-virtual {v6, v8}, Landroid/preference/nubia/CheckBoxPreference;->setChecked(Z)V
    ...
    invoke-virtual {v6, v8}, Landroid/preference/nubia/CheckBoxPreference;->setSummary(I)V

    .line 121
    :cond_2
    iget-object v8, v0, Lcom/android/settings_ex/TrustAgentSettings$AgentInfo;->preference:Landroid/preference/nubia/CheckBoxPreference;
    ...
    .end local v5    # "i":I
    .end local v6    # "preference":Landroid/preference/nubia/CheckBoxPreference;
    :cond_3
    move v4, v7
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 167
    .local v0, "agent":Lcom/android/settings_ex/TrustAgentSettings$AgentInfo;
    iget-object v3, v0, Lcom/android/settings_ex/TrustAgentSettings$AgentInfo;->preference:Landroid/preference/nubia/CheckBoxPreference;
