.class Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver$TransitionFinishObserver;
...
.method public constructor <init>(Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver;Landroid/os/Handler;)V
    ...
    .prologue
    iput-object p1, p0, Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver$TransitionFinishObserver;->this$0:Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver;
...
.method private onChangeInner(Z)V
    ...
    .prologue
    iget-object v2, p0, Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver$TransitionFinishObserver;->this$0:Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver;
    ...
    const-string v3, "nubia_finish_app_transition"

    invoke-static {v2, v3}, Landroid/provider/Settings$Global;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    .local v1, "strStop":Ljava/lang/String;
    iget-object v2, p0, Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver$TransitionFinishObserver;->this$0:Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver;
    ...
    iget-object v4, p0, Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver$TransitionFinishObserver;->this$0:Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver;
    ...
    # getter for: Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver;->mListenedStarting:Z
    invoke-static {v2}, Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver;->access$500(Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver;)Z
    ...
    invoke-interface {v2}, Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver$WindowAnimationListener;->onAnimationEnd()V
    ...
    iget-object v3, p0, Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver$TransitionFinishObserver;->this$0:Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver;

    # getter for: Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver;->mTransitionFinish:Landroid/widget/TextView;
    invoke-static {v3}, Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver;->access$1000(Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver;)Landroid/widget/TextView;
...
.method public onChange(Z)V
    ...
    .prologue
    :try_start_0
    invoke-direct {p0, p1}, Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver$TransitionFinishObserver;->onChangeInner(Z)V
    :try_end_0
    ...
    iget-object v1, p0, Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver$TransitionFinishObserver;->this$0:Lcn/nubia/server/policy/edge/effects/widowobserver/WindowAnimationObserver;
