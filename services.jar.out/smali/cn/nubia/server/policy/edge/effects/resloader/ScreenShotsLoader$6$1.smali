.class Lcn/nubia/server/policy/edge/effects/resloader/ScreenShotsLoader$6$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcn/nubia/server/policy/edge/effects/resloader/ScreenShotsLoader$6;->onProgressUpdate([Lcn/nubia/server/policy/edge/effects/resloader/ScreenShotsLoader$ResultData;)V
.end annotation
...
# instance fields
.field final synthetic this$1:Lcn/nubia/server/policy/edge/effects/resloader/ScreenShotsLoader$6;

.field final synthetic val$data:Lcn/nubia/server/policy/edge/effects/resloader/ScreenShotsLoader$ResultData;


# direct methods
.method constructor <init>(Lcn/nubia/server/policy/edge/effects/resloader/ScreenShotsLoader$6;Lcn/nubia/server/policy/edge/effects/resloader/ScreenShotsLoader$ResultData;)V
    .locals 0
...
.method public run()V
    ...
    iget-object v1, p0, Lcn/nubia/server/policy/edge/effects/resloader/ScreenShotsLoader$6$1;->val$data:Lcn/nubia/server/policy/edge/effects/resloader/ScreenShotsLoader$ResultData;

    iget v1, v1, Lcn/nubia/server/policy/edge/effects/resloader/ScreenShotsLoader$ResultData;->hashCode:I

    iget-object v2, p0, Lcn/nubia/server/policy/edge/effects/resloader/ScreenShotsLoader$6$1;->val$data:Lcn/nubia/server/policy/edge/effects/resloader/ScreenShotsLoader$ResultData;
