.class Lcom/android/server/policy/NubiaGlobalActions$MyAdapter;
...
.method public getCount()I
    ...
    invoke-static {v3}, Lcom/android/server/policy/NubiaGlobalActions;->access$1400(Lcom/android/server/policy/NubiaGlobalActions;)Ljava/util/ArrayList;
    ...
    # getter for: Lcom/android/server/policy/NubiaGlobalActions;->mKeyguardShowing:Z
    invoke-static {v3}, Lcom/android/server/policy/NubiaGlobalActions;->access$1500(Lcom/android/server/policy/NubiaGlobalActions;)Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-interface {v0}, Lcom/android/server/policy/NubiaGlobalActions$Action;->showDuringKeyguard()Z
    ...
    # getter for: Lcom/android/server/policy/NubiaGlobalActions;->mDeviceProvisioned:Z
    invoke-static {v3}, Lcom/android/server/policy/NubiaGlobalActions;->access$1600(Lcom/android/server/policy/NubiaGlobalActions;)Z

    move-result v3

    if-nez v3, :cond_2

    invoke-interface {v0}, Lcom/android/server/policy/NubiaGlobalActions$Action;->showBeforeProvisioning()Z
...
.method public getItem(I)Lcom/android/server/policy/NubiaGlobalActions$Action;
    .locals 6
    .param p1, "position"    # I
    ...
    invoke-virtual {p0}, Lcom/android/server/policy/NubiaGlobalActions$MyAdapter;->getCount()I
    ...
    iget-object v5, p0, Lcom/android/server/policy/NubiaGlobalActions$MyAdapter;->this$0:Lcom/android/server/policy/NubiaGlobalActions;

    # getter for: Lcom/android/server/policy/NubiaGlobalActions;->mKeyguardShowing:Z
    invoke-static {v5}, Lcom/android/server/policy/NubiaGlobalActions;->access$1500(Lcom/android/server/policy/NubiaGlobalActions;)Z
    ...
    # getter for: Lcom/android/server/policy/NubiaGlobalActions;->mDeviceProvisioned:Z
    invoke-static {v5}, Lcom/android/server/policy/NubiaGlobalActions;->access$1600(Lcom/android/server/policy/NubiaGlobalActions;)Z
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object v2, p0, Lcom/android/server/policy/NubiaGlobalActions$MyAdapter;->this$0:Lcom/android/server/policy/NubiaGlobalActions;
    ...
    invoke-interface {v0, v1, p2, p3, v2}, Lcom/android/server/policy/NubiaGlobalActions$Action;->create(Landroid/content/Context;Landroid/view/View;Landroid/view/ViewGroup;Landroid/view/LayoutInflater;)Landroid/view/View;
...
.method public isEnabled(I)Z
    ...
    invoke-interface {v0}, Lcom/android/server/policy/NubiaGlobalActions$Action;->isEnabled()Z
