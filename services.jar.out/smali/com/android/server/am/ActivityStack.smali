...
.method private appLockerProcessAfterResume()V
    ...
    sget-boolean v0, Lcom/android/server/am/AppLockerConfig;->DEBUG:Z
    ...
    const-string v2, "appLockerProcessAfterResume:RESULT_START_PASS,"
    ...
    const-string v2, "appLockerProcessAfterResume:RESULT_TASK_TO_BACK,"
    ...
    const-string v2, "appLockerProcessAfterResume:RESULT_PASS_FINISH,"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, p0, Lcom/android/server/am/ActivityStack;->mFinishPasswordActivity:Lcom/android/server/am/ActivityRecord;
...
.method private resumeLockedAppProcess(Lcom/android/server/am/ActivityRecord;)V
    ...
    const-string v2, "resumeLockedAppProcess:RESULT_START_PASS,"
    ...
    const-string v2, "resumeLockedAppProcess:RESULT_TASK_TO_BACK,"
...
.method private resumeTopActivityInnerLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
    ...
    invoke-interface {v3, v0, v1}, Lcom/android/server/am/IAmSmartShowFuncs;->resumeHomeActivityLocked(Lcom/android/server/am/ActivityStack;Lcom/android/server/am/ActivityRecord;)I
    ...
    invoke-interface {v3}, Lcom/android/server/am/IAmSmartShowFuncs;->withoutMultiWindow()Z
    ...
    .local v24, "manager":Lcom/cmx/cmplus/ISmartContainerManager;
    if-eqz v24, :cond_47
    ...
    invoke-interface {v0, v3}, Lcom/cmx/cmplus/ISmartContainerManager;->setCurrUid(I)V
    :try_end_2
    .catch Landroid/os/RemoteException; {:try_start_2 .. :try_end_2} :catch_1
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_2

    .end local v24    # "manager":Lcom/cmx/cmplus/ISmartContainerManager;
    :cond_47
    :goto_11
    const/4 v3, 0x1
...
.method private resumeUnLockActivityProcess(Lcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-virtual {v1, v2, p1}, Lcom/android/server/am/ActivityLockHelper;->needDestroy(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;)Z
    ...
    const-string v3, "resumeUnLockActivityProcess:mLockedResumeResult="

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Lcom/android/server/am/ActivityStack;->mLockedResumeResult:I
...
.method final moveTaskToFrontLocked(Lcom/android/server/am/TaskRecord;ZLandroid/os/Bundle;Lcom/android/server/am/AppTimeTracker;Ljava/lang/String;)V
    ...
    iget-object v4, v4, Lcom/android/server/am/ActivityManagerService;->mActivityLockHelper:Lcom/android/server/am/ActivityLockHelper;

    invoke-virtual {v4, v8}, Lcom/android/server/am/ActivityLockHelper;->setCallFromMoveToTaskFront(Z)V

    sget-boolean v4, Lcom/android/server/am/AppLockerConfig;->DEBUG:Z
