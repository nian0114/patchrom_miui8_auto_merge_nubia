...
.method static constructor <clinit>()V
    ...
    .line 2688
    invoke-static {}, Lcom/android/server/NetworkManagementService;->registerNatives()I
...
.method public setMultiRouteAuthState(Ljava/lang/String;I)V
    .locals 6
    ...
    const-string v3, "setMultiRouteAuthState Exception: "
...
.method public setMultiRouteEnabled(ZI)V
    .locals 8
    .param p1, "flag"    # Z
    .param p2, "uid"    # I
    ...
    .line 2704
    .local v0, "cmd":Lcom/android/server/NativeDaemonConnector$Command;
    invoke-static {}, Lcom/android/server/NetworkManagementService;->isDriverLoaded()Z

    move-result v1

    .line 2705
    .local v1, "driverLoaded":Z
    const-string v5, "NetworkManagement"
    ...
    const-string v7, "isDriverLoaded: "
    ...
    .line 2709
    invoke-static {}, Lcom/android/server/NetworkManagementService;->loadDriver()Z

    move-result v3

    .line 2710
    .local v3, "loadResult":Z
    const-string v5, "NetworkManagement"
    ...
    const-string v7, "loadDriver result: "
    ...
    .line 2726
    invoke-static {}, Lcom/android/server/NetworkManagementService;->unloadDriver()Z

    move-result v4

    .line 2727
    .local v4, "unloadResult":Z
    const-string v5, "NetworkManagement"
    ...
    const-string v7, "unload Driver result: "
    ...
    const-string v7, "setMultiRouteEnabled Exception: "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    invoke-virtual {v2}, Lcom/android/server/NativeDaemonConnectorException;->toString()Ljava/lang/String;
...
.method public setMultiRouteInterfaceDown(Ljava/lang/String;Z)V
    .locals 7
    .param p1, "name"    # Ljava/lang/String;
    .param p2, "pingResult"    # Z
    ...
    const-string v4, "setMultiRouteInterfaceDown Exception: "
...
.method public setMultiRouteInterfaceUp(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IZ)V
    .locals 7
    .param p1, "name"    # Ljava/lang/String;
    .param p2, "ipAddress"    # Ljava/lang/String;
    .param p3, "dns"    # Ljava/lang/String;
    .param p4, "netMask"    # I
    .param p5, "realConnected"    # Z
    ...
    const-string v4, "setMultiRouteInterfaceUp Exception: "
...
.method public setMultiRouteNetMode(Ljava/lang/String;I)V
    .locals 6
    .param p1, "name"    # Ljava/lang/String;
    .param p2, "mode"    # I
    ...
    const-string v3, "setMultiRouteNetMode Exception: "
...
.method public setMultiRouteWifiModes(Ljava/lang/String;I)V
    .locals 6
    .param p1, "name"    # Ljava/lang/String;
    .param p2, "state"    # I
    ...
    const-string v3, "setMultiRouteWifiModes Exception: "
...
.method public setRestrictedUidList([IIZ)V
    .locals 9
    .param p1, "uidList"    # [I
    .param p2, "len"    # I
    .param p3, "isMobile"    # Z
    ...
    .line 2789
    .local v3, "uidStrBuilder":Ljava/lang/StringBuilder;
    const/4 v1, 0x0
    ...
    .line 2793
    .local v2, "mobileArg":Ljava/lang/String;
    :goto_1
    ...
    .line 2797
    .end local v1    # "i":I
    .end local v2    # "mobileArg":Ljava/lang/String;
    .end local v3    # "uidStrBuilder":Ljava/lang/StringBuilder;
    :goto_2
    return-void

    .line 2792
    .restart local v1    # "i":I
    .restart local v3    # "uidStrBuilder":Ljava/lang/StringBuilder;
    :cond_1
    const-string v2, "0"
    :try_end_0
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v6, "setMultiRouteWifiModes Exception: "
