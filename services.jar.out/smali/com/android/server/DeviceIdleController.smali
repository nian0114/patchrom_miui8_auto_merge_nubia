...
.method private loadSystemAppAllowInPowerSave(Landroid/content/pm/PackageManager;)V
    .locals 11
    ...
    .line 911
    iget-object v7, p0, Lcom/android/server/DeviceIdleController;->mPowerSaveWhitelistSystemAppIdsExceptIdle:Landroid/util/SparseBooleanArray;

    invoke-virtual {v7, v1, v10}, Landroid/util/SparseBooleanArray;->put(IZ)V
    ...
    const-string v9, "loadSystemAppAllowInPowerSave packagename="
...
.method private loadThirdAppAllowInPowerSave(Landroid/content/pm/PackageManager;)V
    .locals 10
    .param p1, "pm"    # Landroid/content/pm/PackageManager;
    ...
    .line 921
    .local v6, "sysConfig":Lcom/android/server/SystemConfig;
    invoke-virtual {v6}, Lcom/android/server/SystemConfig;->getAllowInPowerSave()Landroid/util/ArraySet;
    ...
    :try_start_0
    invoke-virtual {p1, v5, v7}, Landroid/content/pm/PackageManager;->getApplicationInfo(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    const-string v9, "loadThirdAppAllowInPowerSave packagename="
    ...
    const-string v9, "loadThirdAppAllowInPowerSave not found pkg="
...
.method public onStart()V
    ...
    .line 843
    invoke-direct {p0, v6}, Lcom/android/server/DeviceIdleController;->loadSystemAppAllowInPowerSave(Landroid/content/pm/PackageManager;)V
    ...
    .line 881
    invoke-direct {p0, v6}, Lcom/android/server/DeviceIdleController;->loadThirdAppAllowInPowerSave(Landroid/content/pm/PackageManager;)V
