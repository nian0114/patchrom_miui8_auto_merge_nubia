...
.method private updateUsbNotification()V
    ...
    iget-object v0, v0, Lcom/android/server/usb/UsbDeviceManager;->mHelper:Lcom/android/server/usb/UsbDeviceManagerHelper;

    iget-boolean v1, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mConnected:Z

    invoke-virtual {v0, v1, v2}, Lcom/android/server/usb/UsbDeviceManagerHelper;->showOptions(ZLandroid/content/Intent;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v5, v2, Lcom/android/server/usb/UsbDeviceManager;->mHelper:Lcom/android/server/usb/UsbDeviceManagerHelper;
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mAdbEnabled:Z
    invoke-static {v6}, Lcom/android/server/usb/UsbDeviceManager;->access$300(Lcom/android/server/usb/UsbDeviceManager;)Z

    move-result v6

    invoke-virtual {v5, v2, v6}, Lcom/android/server/usb/UsbDeviceManagerHelper;->settingAdbEnable(ZZ)V
    ...
    iget-object v2, v2, Lcom/android/server/usb/UsbDeviceManager;->mHelper:Lcom/android/server/usb/UsbDeviceManagerHelper;

    iget-object v3, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mCurrentFunctions:Ljava/lang/String;

    invoke-virtual {v2, v1, v3}, Lcom/android/server/usb/UsbDeviceManagerHelper;->settingEnabledFunctions(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2}, Lcom/android/server/usb/UsbDeviceManagerHelper;->markBootCompleted()V
