...
.field private static dump_Alarm_showLOGV:Z
...
.field private mPowerOffOperation:Landroid/app/PendingIntent;

.field private mPowerOffWakeUpOperation:Landroid/app/PendingIntent;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/AlarmManagerService;->dump_Alarm_showLOGV:Z
...
.method static synthetic access$1100(Lcom/android/server/AlarmManagerService;Ljava/lang/String;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/AlarmManagerService;
    ...
    .prologue
    invoke-direct {p0, p1, p2}, Lcom/android/server/AlarmManagerService;->removePackagePrio(Ljava/lang/String;I)V
...
.method static synthetic access$302(Z)Z
    ...
    .prologue
    sput-boolean p0, Lcom/android/server/AlarmManagerService;->dump_Alarm_showLOGV:Z
...
.method static synthetic access$500(Lcom/android/server/AlarmManagerService;)Landroid/app/PendingIntent;
    ...
    .prologue
    iget-object v0, p0, Lcom/android/server/AlarmManagerService;->mPowerOffWakeUpOperation:Landroid/app/PendingIntent;
...
.method static synthetic access$502(Lcom/android/server/AlarmManagerService;Landroid/app/PendingIntent;)Landroid/app/PendingIntent;
    ...
    .prologue
    iput-object p1, p0, Lcom/android/server/AlarmManagerService;->mPowerOffWakeUpOperation:Landroid/app/PendingIntent;
...
.method static synthetic access$600(Lcom/android/server/AlarmManagerService;)Landroid/app/PendingIntent;
    ...
    .prologue
    iget-object v0, p0, Lcom/android/server/AlarmManagerService;->mPowerOffOperation:Landroid/app/PendingIntent;

    return-object v0
.end method

.method static synthetic access$602(Lcom/android/server/AlarmManagerService;Landroid/app/PendingIntent;)Landroid/app/PendingIntent;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/AlarmManagerService;
    .param p1, "x1"    # Landroid/app/PendingIntent;

    .prologue
    iput-object p1, p0, Lcom/android/server/AlarmManagerService;->mPowerOffOperation:Landroid/app/PendingIntent;
...
.method private getNewPackageName(Ljava/lang/String;I)Ljava/lang/String;
    .locals 2
...
.method private getPackagePrio(Ljava/lang/String;I)Lcom/android/server/AlarmManagerService$PriorityClass;
    .locals 2
    .param p1, "packageName"    # Ljava/lang/String;
    .param p2, "userHandle"    # I

    .prologue
    iget-object v0, p0, Lcom/android/server/AlarmManagerService;->mPriorities:Ljava/util/HashMap;

    invoke-direct {p0, p1, p2}, Lcom/android/server/AlarmManagerService;->getNewPackageName(Ljava/lang/String;I)Ljava/lang/String;
    ...
    check-cast v0, Lcom/android/server/AlarmManagerService$PriorityClass;
...
.method private removePackagePrio(Ljava/lang/String;I)V
    .locals 2
    .param p1, "packageName"    # Ljava/lang/String;
    .param p2, "userHandle"    # I
...
.method private setPackagePrio(Ljava/lang/String;ILcom/android/server/AlarmManagerService$PriorityClass;)V
    .locals 2
    .param p1, "packageName"    # Ljava/lang/String;
    .param p2, "userHandle"    # I
    .param p3, "packagePrio"    # Lcom/android/server/AlarmManagerService$PriorityClass;
...
.method calculateDeliveryPriorities(Ljava/util/ArrayList;)V
    ...
    invoke-direct {p0, v5, v6}, Lcom/android/server/AlarmManagerService;->getPackagePrio(Ljava/lang/String;I)Lcom/android/server/AlarmManagerService$PriorityClass;
    ...
    invoke-direct {p0, v5, v6, v4}, Lcom/android/server/AlarmManagerService;->setPackagePrio(Ljava/lang/String;ILcom/android/server/AlarmManagerService$PriorityClass;)V
...
.method lookForPackageLocked(Ljava/lang/String;I)Z
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/AlarmManagerService$Batch;->hasPackage(Ljava/lang/String;I)Z
...
.method removeImpl(Landroid/app/PendingIntent;)V
    ...
    :cond_0
    const-string v0, "persist.service.powersave.logs"
...
.method removeLocked(Ljava/lang/String;I)V
    ...
    .local v0, "b":Lcom/android/server/AlarmManagerService$Batch;
    invoke-virtual {v0, p1, p2}, Lcom/android/server/AlarmManagerService$Batch;->remove(Ljava/lang/String;I)Z
...
.method setImpl(IJJJLandroid/app/PendingIntent;ILandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;I)V
    ...
    :cond_0
    sget-boolean v8, Lcn/nubia/server/appmgmt/ApplicationManagerConfig;->ENABLE:Z
    ...
    :cond_4
    sget-boolean v8, Lcn/nubia/server/appmgmt/ApplicationManagerConfig;->DEBUG:Z
    ...
    iget-boolean v8, v0, Lcom/android/server/AlarmManagerService;->mInteractive:Z
    ...
    invoke-virtual/range {v4 .. v14}, Lcom/android/server/AlarmManagerService;->setImpl_dump_Alarm_showLOGV(IJJJLandroid/app/PendingIntent;Landroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;)V
    ...
    .end local v28    # "minInterval":J
    :cond_a
    const-string v8, "AlarmManager"

    const-string v9, "none no open power log"

    invoke-static {v8, v9}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;)I

    goto/16 :goto_1

    .restart local v28    # "minInterval":J
    :cond_b
    const-wide/16 v8, 0x0
...
.method setImpl_dump_Alarm_showLOGV(IJJJLandroid/app/PendingIntent;Landroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;)V
    .locals 8
    .param p1, "type"    # I
    .param p2, "triggerAtTime"    # J
    .param p4, "windowLength"    # J
    ...
    iget-object v5, p0, Lcom/android/server/AlarmManagerService;->showSDF:Ljava/text/SimpleDateFormat;
    ...
    const-string v5, " !!!take care!!!, it is a wakeup timer(type=0/2)."
    ...
    invoke-static {v4}, Lcom/android/server/AlarmManagerService;->timerLog(Ljava/lang/String;)V
