...
.method private applyDefaultPreferredActivityLPw(Lcom/android/server/pm/PackageManagerService;Landroid/content/Intent;ILandroid/content/ComponentName;Ljava/lang/String;Landroid/os/PatternMatcher;Landroid/content/IntentFilter$AuthorityEntry;Landroid/os/PatternMatcher;I)V
    ...
    iget-object v7, v0, Lcom/android/server/pm/PackageManagerService;->mActivities:Lcom/android/server/pm/IActivityIntentResolver;
    ...
    invoke-interface {v7, v0, v8, v1, v2}, Lcom/android/server/pm/IActivityIntentResolver;->queryIntent(Landroid/content/Intent;Ljava/lang/String;II)Ljava/util/List;
...
.method createNewUserLILPw(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/Installer;I)V
    ...
    .local v6, "cloneEnabling":Z
    :try_start_0
    invoke-static {}, Lcom/cmx/cmplus/SmartContainerManagerNative;->get()Lcom/cmx/cmplus/ISmartContainerManager;

    move-result-object v0

    invoke-interface {v0}, Lcom/cmx/cmplus/ISmartContainerManager;->isCloneEnabling()Z
    :try_end_0
    ...
    .restart local v6    # "cloneEnabling":Z
    :cond_1
    ...
    :goto_2
    invoke-virtual {v8, v0, p3}, Lcom/android/server/pm/PackageSetting;->setInstalled(ZI)V
    ...
    :cond_5
    iget v1, v8, Lcom/android/server/pm/PackageSetting;->pkgFlags:I
