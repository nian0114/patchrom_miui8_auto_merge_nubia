...
.method private run()V
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/android/server/SystemServer;->setDeviceCountry()V
    :try_end_0
    ...
    const-string v1, "setDeviceCountry failed"
...
.method private setCountryToPersist()Ljava/lang/String;
    .locals 10

    .prologue
    const-string v1, "/persist/country.ini"

    .local v1, "configFile":Ljava/lang/String;
    const-string v5, ""

    .local v5, "strCountry":Ljava/lang/String;
    const-string v7, "persist.sys.device.country"
    ...
    .end local v5    # "strCountry":Ljava/lang/String;
    .local v6, "strCountry":Ljava/lang/String;
    :goto_0
    return-object v6

    .end local v6    # "strCountry":Ljava/lang/String;
    .restart local v5    # "strCountry":Ljava/lang/String;
    :cond_0
    ...
    const-string v7, "/persist/country.ini"
    ...
    .end local v5    # "strCountry":Ljava/lang/String;
    .restart local v6    # "strCountry":Ljava/lang/String;
    goto :goto_0
    ...
    const-string v8, "Failed to load config file."
...
.method private setDeviceCountry()V
    .locals 1
    ...
    invoke-direct {p0}, Lcom/android/server/SystemServer;->setCountryToPersist()Ljava/lang/String;

    move-result-object v0

    invoke-direct {p0, v0}, Lcom/android/server/SystemServer;->setPhoneNumerMatchLen(Ljava/lang/String;)V

    return-void
.end method

.method private setPhoneNumerMatchLen(Ljava/lang/String;)V
    .locals 3
    .param p1, "country"    # Ljava/lang/String;

    .prologue
    const-string v1, "persist.sys.c.phone.matchnum"
