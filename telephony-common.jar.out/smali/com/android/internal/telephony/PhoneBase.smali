...
.field protected static final EVENT_DEACTIVATE_DETECT_PBS_DONE:I = 0x2e
...
.field protected static final EVENT_SETUP_DETECT_PBS_DONE:I = 0x2d
...
.field protected static final EVENT_SET_PBS_DONE:I = 0x2f
...
.field private static PBS_CMD_DONE_KEY:Ljava/lang/String; = null

.field public static PBS_DISABLE:I = 0x0

.field private static PBS_DONE:I = 0x0

.field public static PBS_ENABLE:I = 0x0

.field public static PBS_STATE_CONTENT_KEY:Ljava/lang/String; = null

.field public static final PROPERTY_OOS_IS_DISCONNECT:Ljava/lang/String; = "persist.telephony.oosisdc"

.field private static SEND_PBS_CMD_SUCCESS:I = 0x0
...
.method static constructor <clinit>()V
    ...
    sput v1, Lcom/android/internal/telephony/PhoneBase;->SEND_PBS_CMD_SUCCESS:I

    const-string v0, "com.android.internal.pbsEnable"

    sput-object v0, Lcom/android/internal/telephony/PhoneBase;->PBS_STATE_CONTENT_KEY:Ljava/lang/String;

    sput v1, Lcom/android/internal/telephony/PhoneBase;->PBS_DISABLE:I

    sput v2, Lcom/android/internal/telephony/PhoneBase;->PBS_ENABLE:I

    const-string v0, "com.android.internal.pbsDone"

    sput-object v0, Lcom/android/internal/telephony/PhoneBase;->PBS_CMD_DONE_KEY:Ljava/lang/String;

    sput v2, Lcom/android/internal/telephony/PhoneBase;->PBS_DONE:I

    const/16 v0, 0x1f4

    sput v0, Lcom/android/internal/telephony/PhoneBase;->DELAY_TIME:I
...
.method protected constructor <init>(Ljava/lang/String;Lcom/android/internal/telephony/PhoneNotifier;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;ZI)V
    ...
    iput-boolean v7, p0, Lcom/android/internal/telephony/PhoneBase;->mImsIntentReceiverRegistered:Z

    new-instance v7, Lcom/android/internal/telephony/PhoneBase$1;

    invoke-direct {v7, p0}, Lcom/android/internal/telephony/PhoneBase$1;-><init>(Lcom/android/internal/telephony/PhoneBase;)V

    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mImsIntentReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-boolean v7, p0, Lcom/android/internal/telephony/PhoneBase;->mIsVideoCapable:Z
    ...
    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mIccRecords:Ljava/util/concurrent/atomic/AtomicReference;

    new-instance v7, Ljava/util/concurrent/atomic/AtomicReference;

    invoke-direct {v7}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V

    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mUiccApplication:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mRadioCapability:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    const-string v7, "persist.telephony.oosisdc"
    ...
    iput-boolean v7, p0, Lcom/android/internal/telephony/PhoneBase;->mOosIsDisconnect:Z

    new-instance v7, Landroid/os/RegistrantList;

    invoke-direct {v7}, Landroid/os/RegistrantList;-><init>()V

    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mPreciseCallStateRegistrants:Landroid/os/RegistrantList;

    new-instance v7, Landroid/os/RegistrantList;

    invoke-direct {v7}, Landroid/os/RegistrantList;-><init>()V

    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mHandoverRegistrants:Landroid/os/RegistrantList;

    new-instance v7, Landroid/os/RegistrantList;

    invoke-direct {v7}, Landroid/os/RegistrantList;-><init>()V

    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mNewRingingConnectionRegistrants:Landroid/os/RegistrantList;

    new-instance v7, Landroid/os/RegistrantList;

    invoke-direct {v7}, Landroid/os/RegistrantList;-><init>()V

    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mIncomingRingRegistrants:Landroid/os/RegistrantList;

    new-instance v7, Landroid/os/RegistrantList;

    invoke-direct {v7}, Landroid/os/RegistrantList;-><init>()V

    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mDisconnectRegistrants:Landroid/os/RegistrantList;

    new-instance v7, Landroid/os/RegistrantList;

    invoke-direct {v7}, Landroid/os/RegistrantList;-><init>()V

    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mServiceStateRegistrants:Landroid/os/RegistrantList;

    new-instance v7, Landroid/os/RegistrantList;

    invoke-direct {v7}, Landroid/os/RegistrantList;-><init>()V

    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mMmiCompleteRegistrants:Landroid/os/RegistrantList;

    new-instance v7, Landroid/os/RegistrantList;

    invoke-direct {v7}, Landroid/os/RegistrantList;-><init>()V

    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mMmiRegistrants:Landroid/os/RegistrantList;

    new-instance v7, Landroid/os/RegistrantList;

    invoke-direct {v7}, Landroid/os/RegistrantList;-><init>()V

    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mUnknownConnectionRegistrants:Landroid/os/RegistrantList;

    new-instance v7, Landroid/os/RegistrantList;

    invoke-direct {v7}, Landroid/os/RegistrantList;-><init>()V

    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mSuppServiceFailedRegistrants:Landroid/os/RegistrantList;

    new-instance v7, Landroid/os/RegistrantList;

    invoke-direct {v7}, Landroid/os/RegistrantList;-><init>()V

    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mRadioOffOrNotAvailableRegistrants:Landroid/os/RegistrantList;

    new-instance v7, Landroid/os/RegistrantList;

    invoke-direct {v7}, Landroid/os/RegistrantList;-><init>()V

    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mSimRecordsLoadedRegistrants:Landroid/os/RegistrantList;

    new-instance v7, Landroid/os/RegistrantList;

    invoke-direct {v7}, Landroid/os/RegistrantList;-><init>()V

    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mVideoCapabilityChangedRegistrants:Landroid/os/RegistrantList;

    new-instance v7, Landroid/os/RegistrantList;

    invoke-direct {v7}, Landroid/os/RegistrantList;-><init>()V

    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mEmergencyCallToggledRegistrants:Landroid/os/RegistrantList;

    new-instance v7, Lcom/android/internal/telephony/PhoneBase$2;

    invoke-direct {v7, p0}, Lcom/android/internal/telephony/PhoneBase$2;-><init>(Lcom/android/internal/telephony/PhoneBase;)V

    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mLooper:Landroid/os/Looper;
    ...
    const-string v8, ".action_detached"
    ...
    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mActionDetached:Ljava/lang/String;
    ...
    const-string v8, ".action_attached"
    ...
    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mActionAttached:Ljava/lang/String;

    sget-boolean v7, Landroid/os/Build;->IS_DEBUGGABLE:Z

    if-eqz v7, :cond_0

    new-instance v7, Lcom/android/internal/telephony/TelephonyTester;

    invoke-direct {v7, p0}, Lcom/android/internal/telephony/TelephonyTester;-><init>(Lcom/android/internal/telephony/PhoneBase;)V

    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mTelephonyTester:Lcom/android/internal/telephony/TelephonyTester;

    :cond_0
    move/from16 v0, p5

    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/PhoneBase;->setUnitTestMode(Z)V
    ...
    const-string v7, "dns_server_check_disabled_key"
    ...
    iput-boolean v7, p0, Lcom/android/internal/telephony/PhoneBase;->mDnsCheckDisabled:Z
    ...
    invoke-interface {v7, p0, v8, v9}, Lcom/android/internal/telephony/CommandsInterface;->setOnCallRing(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    const-string v7, "ro.telephony.call_ring.multiple"
    ...
    iput-boolean v7, p0, Lcom/android/internal/telephony/PhoneBase;->mDoesRilSendMultipleCallRing:Z
    ...
    const-string v9, "mDoesRilSendMultipleCallRing="
    ...
    const-string v7, "ro.telephony.call_ring.delay"
    ...
    iput v7, p0, Lcom/android/internal/telephony/PhoneBase;->mCallRingDelay:I
    ...
    const-string v9, "mCallRingDelay="

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, p0, Lcom/android/internal/telephony/PhoneBase;->mCallRingDelay:I
    ...
    invoke-static {v7}, Lcom/android/internal/telephony/PhoneBase;->getLocaleFromCarrierProperties(Landroid/content/Context;)Ljava/util/Locale;
    ...
    :cond_2
    :goto_1
    new-instance v7, Lcom/android/internal/telephony/SmsStorageMonitor;

    invoke-direct {v7, p0}, Lcom/android/internal/telephony/SmsStorageMonitor;-><init>(Lcom/android/internal/telephony/PhoneBase;)V

    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mSmsStorageMonitor:Lcom/android/internal/telephony/SmsStorageMonitor;

    new-instance v7, Lcom/android/internal/telephony/SmsUsageMonitor;

    invoke-direct {v7, p3}, Lcom/android/internal/telephony/SmsUsageMonitor;-><init>(Landroid/content/Context;)V

    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mSmsUsageMonitor:Lcom/android/internal/telephony/SmsUsageMonitor;
    ...
    iget-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mUiccController:Lcom/android/internal/telephony/uicc/UiccController;

    const/16 v8, 0x1e

    const/4 v9, 0x0

    invoke-virtual {v7, p0, v8, v9}, Lcom/android/internal/telephony/uicc/UiccController;->registerForIccChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v7, p0, v8, v9}, Lcom/android/internal/telephony/CommandsInterface;->registerForSrvccStateChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v7, p0, v8, v9}, Lcom/android/internal/telephony/CommandsInterface;->setOnUnsolOemHookRaw(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v7, v8, v9, v10}, Lcom/android/internal/telephony/CommandsInterface;->startLceService(IZLandroid/os/Message;)V
    ...
    const-string v9, "mOosIsDisconnect="

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-boolean v9, p0, Lcom/android/internal/telephony/PhoneBase;->mOosIsDisconnect:Z
    ...
    const-string v7, "org.codeaurora.intent.action.ACTION_RADIO_CAPABILITY_UPDATED"

    invoke-virtual {v4, v7}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    iget-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mContext:Landroid/content/Context;

    iget-object v8, p0, Lcom/android/internal/telephony/PhoneBase;->mReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-virtual {v6, v2, v7}, Landroid/net/wifi/WifiManager;->setCountryCode(Ljava/lang/String;Z)V
...
.method private setPBSDone()V
    ...
    sget-object v1, Lcom/android/internal/telephony/PhoneBase;->PBS_CMD_DONE_KEY:Ljava/lang/String;

    sget v2, Lcom/android/internal/telephony/PhoneBase;->PBS_DONE:I
...
.method public dispose()V
    ...
    iget-object v3, p0, Lcom/android/internal/telephony/PhoneBase;->mReceiver:Landroid/content/BroadcastReceiver;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mSmscAddress:Ljava/lang/String;
    ...
    iget-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mAddressToSet:Ljava/lang/String;
    ...
    .end local v0    # "ar":Landroid/os/AsyncResult;
    :pswitch_d
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/PhoneBase;->handleSetupDetectPBS(Landroid/os/Message;)V

    goto/16 :goto_0

    :pswitch_e
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/PhoneBase;->handleDeactivateDetectPBS(Landroid/os/Message;)V

    goto/16 :goto_0

    :pswitch_f
    invoke-direct {p0}, Lcom/android/internal/telephony/PhoneBase;->setPBSDone()V
...
.method public setDetectPseudoBaseStationEnabled(Z)V
    .locals 3
    .param p1, "enable"    # Z
    ...
    const-string v2, "setDetectPseudoBaseStationEnabled: "
    ...
    invoke-interface {v0, v1}, Lcom/android/internal/telephony/CommandsInterface;->setupDetectPBS(Landroid/os/Message;)V
    ...
    invoke-interface {v0, v1}, Lcom/android/internal/telephony/CommandsInterface;->deactivateDetectPBS(Landroid/os/Message;)V
