...
.method static synthetic access$12000(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;
    .param p1, "x1"    # Ljava/lang/String;
...
.method private getPersistedDeviceName()Ljava/lang/String;
    ...
    # invokes: Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->isValideDeviceName(Ljava/lang/String;)Z
    invoke-static {v2, v0}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$13400(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;Ljava/lang/String;)Z
    ...
    .line 2850
    .local v1, "wifi_direct_name":Ljava/lang/String;
    ...
    .end local v1    # "wifi_direct_name":Ljava/lang/String;
    :cond_1
    :goto_0
    return-object v0
    ...
    .restart local v1    # "wifi_direct_name":Ljava/lang/String;
    :cond_2
    iget-object v2, p0, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->this$0:Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;

    # invokes: Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->getNubiaDeviceName()Ljava/lang/String;
    invoke-static {v2}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$13500(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;)Ljava/lang/String;
...
.method private notifyInvitationReceived()V
    ...
    iget-object v8, v9, Landroid/net/wifi/p2p/WifiP2pConfig;->wps:Landroid/net/wifi/WpsInfo;

    .line 2457
    .local v8, "wps":Landroid/net/wifi/WpsInfo;
    ...
    invoke-static {v9}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$13200(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;)Ljava/lang/String;
    ...
    invoke-static {v9, v11}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$13202(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;Ljava/lang/String;)Ljava/lang/String;

    .line 2460
    const v9, 0x23002

    invoke-virtual {p0, v9}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->sendMessage(I)V
    ...
    .line 2470
    .local v3, "mTitleView":Landroid/view/View;
    const v9, 0x30d0084
    ...
    .line 2471
    .local v7, "wifiP2pTitle":Landroid/widget/TextView;
    const v9, 0x10403b8
    ...
    invoke-direct {p0, v2, v9, v10}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->addRowToDialog(Landroid/view/ViewGroup;ILjava/lang/String;)V
    ...
    invoke-virtual {v9, v3}, Landroid/app/AlertDialog$Builder;->setCustomTitle(Landroid/view/View;)Landroid/app/AlertDialog$Builder;
    ...
    new-instance v11, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine$5;

    invoke-direct {v11, p0, v8, v4}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine$5;-><init>(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Landroid/net/wifi/WpsInfo;Landroid/widget/EditText;)V
    ...
    new-instance v11, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine$4;

    invoke-direct {v11, p0}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine$4;-><init>(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;)V
    ...
    new-instance v10, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine$3;

    invoke-direct {v10, p0}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine$3;-><init>(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;)V
    ...
    invoke-virtual {v1, v9}, Landroid/app/AlertDialog;->setOnKeyListener(Landroid/content/DialogInterface$OnKeyListener;)V
    ...
    const-string v9, "Enter pin section visible"
    ...
    const-string v9, "Shown pin section visible"
...
.method private setAndPersistDeviceName(Ljava/lang/String;)Z
    ...
    # invokes: Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->isValideDeviceName(Ljava/lang/String;)Z
    invoke-static {v1, p1}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$13400(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;Ljava/lang/String;)Z
    ...
    const-string v2, "invlaid device name "
