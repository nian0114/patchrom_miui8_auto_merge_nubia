...
.field public silentExitConditionId:Landroid/net/Uri;
...
.method public constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object v4, p0, Landroid/service/notification/ZenModeConfig;->customizeContacts:Ljava/util/HashMap;
    ...
    :goto_6
    iput-boolean v5, p0, Landroid/service/notification/ZenModeConfig;->timingZenMode:Z
    ...
    iput-object v4, p0, Landroid/service/notification/ZenModeConfig;->silentExitCondition:Landroid/service/notification/Condition;
    ...
    iput-object v4, p0, Landroid/service/notification/ZenModeConfig;->silentExitConditionId:Landroid/net/Uri;
    ...
    iput-object v4, p0, Landroid/service/notification/ZenModeConfig;->silentExitConditionComponent:Landroid/content/ComponentName;
...
.method private diff(Landroid/service/notification/ZenModeConfig;)Landroid/service/notification/ZenModeConfig$Diff;
    ...
    .line 309
    iget-boolean v7, p0, Landroid/service/notification/ZenModeConfig;->timingZenMode:Z

    iget-boolean v8, p1, Landroid/service/notification/ZenModeConfig;->timingZenMode:Z

    if-eq v7, v8, :cond_d

    .line 310
    const-string/jumbo v7, "timingZenMode"

    iget-boolean v8, p0, Landroid/service/notification/ZenModeConfig;->timingZenMode:Z

    invoke-static {v8}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v8

    iget-boolean v9, p1, Landroid/service/notification/ZenModeConfig;->timingZenMode:Z
    ...
    .line 312
    :cond_d
    iget-object v7, p0, Landroid/service/notification/ZenModeConfig;->silentExitCondition:Landroid/service/notification/Condition;

    iget-object v8, p1, Landroid/service/notification/ZenModeConfig;->silentExitCondition:Landroid/service/notification/Condition;

    if-eq v7, v8, :cond_e

    .line 313
    const-string/jumbo v7, "silentExitCondition"

    iget-object v8, p0, Landroid/service/notification/ZenModeConfig;->silentExitCondition:Landroid/service/notification/Condition;

    iget-object v9, p1, Landroid/service/notification/ZenModeConfig;->silentExitCondition:Landroid/service/notification/Condition;

    invoke-virtual {v2, v7, v8, v9}, Landroid/service/notification/ZenModeConfig$Diff;->addLine(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)Landroid/service/notification/ZenModeConfig$Diff;

    .line 315
    :cond_e
    iget-object v7, p0, Landroid/service/notification/ZenModeConfig;->silentExitConditionComponent:Landroid/content/ComponentName;

    iget-object v8, p1, Landroid/service/notification/ZenModeConfig;->silentExitConditionComponent:Landroid/content/ComponentName;

    if-eq v7, v8, :cond_f

    .line 316
    const-string/jumbo v7, "silentExitConditionComponent"

    iget-object v8, p0, Landroid/service/notification/ZenModeConfig;->silentExitConditionComponent:Landroid/content/ComponentName;

    iget-object v9, p1, Landroid/service/notification/ZenModeConfig;->silentExitConditionComponent:Landroid/content/ComponentName;

    invoke-virtual {v2, v7, v8, v9}, Landroid/service/notification/ZenModeConfig$Diff;->addLine(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)Landroid/service/notification/ZenModeConfig$Diff;

    .line 318
    :cond_f
    iget-object v7, p0, Landroid/service/notification/ZenModeConfig;->customizeContacts:Ljava/util/HashMap;

    iget-object v8, p1, Landroid/service/notification/ZenModeConfig;->customizeContacts:Ljava/util/HashMap;

    if-eq v7, v8, :cond_0

    .line 319
    const-string v7, "customizeContacts"

    iget-object v8, p0, Landroid/service/notification/ZenModeConfig;->customizeContacts:Ljava/util/HashMap;

    iget-object v9, p1, Landroid/service/notification/ZenModeConfig;->customizeContacts:Ljava/util/HashMap;
...
.method public static readXml(Lorg/xmlpull/v1/XmlPullParser;Landroid/service/notification/ZenModeConfig$Migration;)Landroid/service/notification/ZenModeConfig;
    ...
    .line 522
    iget-object v10, v5, Landroid/service/notification/ZenModeConfig;->customizeContacts:Ljava/util/HashMap;

    invoke-static {p0}, Landroid/service/notification/ZenModeConfig;->readCustomizeContactsFromXml(Lorg/xmlpull/v1/XmlPullParser;)Ljava/util/HashMap;
    ...
    .line 536
    const-string/jumbo v10, "timingZenMode"
    ...
    iput-boolean v10, v5, Landroid/service/notification/ZenModeConfig;->timingZenMode:Z

    goto/16 :goto_1

    .line 537
    :cond_c
    const-string/jumbo v10, "silentExitCondition"
    ...
    iput-object v10, v5, Landroid/service/notification/ZenModeConfig;->silentExitCondition:Landroid/service/notification/Condition;

    .line 539
    iget-object v10, v5, Landroid/service/notification/ZenModeConfig;->silentExitCondition:Landroid/service/notification/Condition;

    if-eqz v10, :cond_4

    .line 540
    const-string/jumbo v10, "silentComponent"

    invoke-static {p0, v10}, Landroid/service/notification/ZenModeConfig;->safeComponentName(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Landroid/content/ComponentName;

    move-result-object v10

    iput-object v10, v5, Landroid/service/notification/ZenModeConfig;->silentExitConditionComponent:Landroid/content/ComponentName;
...
.method public toString()Ljava/lang/String;
    ...
    const-string v1, ",customizeContacts="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-object v1, p0, Landroid/service/notification/ZenModeConfig;->customizeContacts:Ljava/util/HashMap;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 241
    iget-object v4, p0, Landroid/service/notification/ZenModeConfig;->silentExitConditionId:Landroid/net/Uri;
...
.method public writeXml(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    .line 585
    const-string/jumbo v4, "timingZenMode"

    iget-boolean v5, p0, Landroid/service/notification/ZenModeConfig;->timingZenMode:Z
    ...
    .line 588
    const-string/jumbo v4, "silentExitCondition"

    invoke-interface {p1, v6, v4}, Lorg/xmlpull/v1/XmlSerializer;->startTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    .line 589
    const-string/jumbo v4, "silentComponent"

    iget-object v5, p0, Landroid/service/notification/ZenModeConfig;->silentExitConditionComponent:Landroid/content/ComponentName;
    ...
    invoke-static {v4, p1}, Landroid/service/notification/ZenModeConfig;->writeConditionXml(Landroid/service/notification/Condition;Lorg/xmlpull/v1/XmlSerializer;)V
