...
.field public mCloneExtras:Landroid/os/Bundle;
...
.method public constructor <init>(Landroid/content/Intent;)V
    ...
    iget-object v0, p1, Landroid/content/Intent;->mCloneExtras:Landroid/os/Bundle;

    if-eqz v0, :cond_5

    new-instance v0, Landroid/os/Bundle;

    iget-object v1, p1, Landroid/content/Intent;->mCloneExtras:Landroid/os/Bundle;

    invoke-direct {v0, v1}, Landroid/os/Bundle;-><init>(Landroid/os/Bundle;)V

    iput-object v0, p0, Landroid/content/Intent;->mCloneExtras:Landroid/os/Bundle;
...
.method public fillIn(Landroid/content/Intent;I)I
    ...
    :cond_13
    sget-boolean v4, Lcom/cmx/cmplus/SmartContainerConfig;->WITH_OUT_ALL:Z

    if-nez v4, :cond_14

    iget-object v4, p1, Landroid/content/Intent;->mCloneExtras:Landroid/os/Bundle;

    if-eqz v4, :cond_14

    new-instance v4, Landroid/os/Bundle;

    iget-object v5, p1, Landroid/content/Intent;->mCloneExtras:Landroid/os/Bundle;

    invoke-direct {v4, v5}, Landroid/os/Bundle;-><init>(Landroid/os/Bundle;)V

    iput-object v4, p0, Landroid/content/Intent;->mCloneExtras:Landroid/os/Bundle;
...
.method public readFromParcel(Landroid/os/Parcel;)V
    ...
    sget-boolean v3, Lcom/cmx/cmplus/SmartContainerConfig;->WITH_OUT_ALL:Z
    ...
    iput-object v3, p0, Landroid/content/Intent;->mCloneExtras:Landroid/os/Bundle;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    sget-boolean v2, Lcom/cmx/cmplus/SmartContainerConfig;->WITH_OUT_ALL:Z

    if-nez v2, :cond_3

    iget-object v2, p0, Landroid/content/Intent;->mCloneExtras:Landroid/os/Bundle;
